    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-700">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-purple-900 rounded-full">
            <Pill className="h-8 w-8 text-purple-400" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">Pharmacy Signup</h1>
          <p className="text-gray-400">Create pharmacy account</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 pr-12 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 text-white"
                required
              />
              <button
                type="button"
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400">
            ...
            <Link to="/pharmacy-login" className="text-purple-400 hover:text-purple-300 font-medium">
              Login
            </Link>
          </p>
        </div>
