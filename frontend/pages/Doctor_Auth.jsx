...
const Doctor_Auth = () => {
	...
	const handleSubmit = async (e) => {
		...
		const result = await authLogin(formData.email, formData.password, "doctor");
		...
		<div className="flex min-h-screen bg-gray-900">
			...
			<div className="w-3/5 flex flex-col justify-center items-center p-12">
				<div className="w-full max-w-md">
					...
					<div className="bg-gray-800 border border-cyan-500 rounded-lg p-4 mb-6">
						<p className="text-cyan-400 font-semibold mb-2 text-center">Demo Credentials</p>
						<p className="text-gray-300 text-sm"><span className="font-medium">Email:</span> doctor@demo.com</p>
						<p className="text-gray-300 text-sm"><span className="font-medium">Password:</span> doctor123</p>
					</div>
					...
					<form onSubmit={handleSubmit}>
						...
						<p className="text-center text-gray-400 text-xs mt-4">
							{t("noAccount")}{" "}
							<a href="/doctor-signup" className="text-blue-400 hover:text-blue-300">
								{t("signUp")}
							</a>
						</p>
					</form>
